...
Schematic energy-level diagram of dressed states. This figure corresponds to the zero-detuning case ($\omega = \Delta$), where $g_0:=g$ is the Rabi frequency. Image source: Internet
...
Zeros of $G_{\pm}(x)$. Image source: [1]
