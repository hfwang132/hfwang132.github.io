...
诺奖得主 Ketterle 在[公开课 8.422](https://av.tib.eu/media/42704) 中讲经典热光场的 \(g^{(2)}\) 时用了一个非常妙的论证：
...
量子 \(g^{(2)}\) 还有一个特殊之处：对于热光场而言，即使只有一个频率模式，该模式也能表现出量子 \(g^{(2)}\) 为 2。而对于经典热光场而言，之前的论证可能涉及不同模式之间的叠加。这一点在 [8.422 公开课](https://av.tib.eu/media/42704) 中一度引起了困惑。
