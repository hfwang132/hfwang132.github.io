...
date: 2023-07-15T16:52:03+08:00
originalURL: "https://www.zhihu.com/question/41140093/answer/3120054519"
aliases:
  - "/en/lie_derivative/"
  - "/en/Post_20240126_李导数与协变导数有什么联系/"
draft: false
...
1. First, let point $P$ "flow" a certain distance downstream along the integral curve to point $Q$, i.e., $\Phi_t (P) =Q$,
...
Given a local coordinate system, such an artificial rule can be characterized by a set of data called Christoffel symbols $\Gamma^i_{jk}$:

$\nabla_{k} e_j =: \Gamma^i_{jk}e_i, \quad \nabla_i := \nabla_{e_i}$ 

The three subscripts of $\Gamma^i_{jk}$ mean: $k$ represents the direction along the $k$-th basis vector, $j$ indicates the basis vector we are considering, and $i$ represents the component of the change along the $i$-th basis vector.
...
>   
> In the formula, a comma with a subscript indicates partial differentiation, i.e., $A_{,k}:=\frac{\partial}{\partial k}A$.

From the formulas, it can be seen that the Lie derivative $\mathcal{L}_V$ at a point depends on the properties of $V$ in the neighborhood of that point because it involves the partial derivatives of the components of the vector field $V^m_{,k}$.
