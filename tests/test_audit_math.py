...
class MathAuditTests(unittest.TestCase):
    ...
    def test_dollar_math_pattern_finds_html_sensitive_operator(self):
        match = MODULE.DOLLAR_MATH.search(r"Text $0<x<1$ text")
